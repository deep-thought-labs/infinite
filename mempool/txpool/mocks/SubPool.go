...
// Init provides a mock function with given fields: gasTip, head, _a2
func (_m *SubPool) Init(gasTip uint64, head *types.Header, _a2 reserver.Reserver) error {
	ret := _m.Called(gasTip, head, _a2)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(uint64, *types.Header, reserver.Reserver) error); ok {
		r0 = rf(gasTip, head, _a2)
	} else {
		r0 = ret.Error(0)
	}
