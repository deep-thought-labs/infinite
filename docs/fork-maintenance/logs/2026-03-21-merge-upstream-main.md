...
| Test de upgrade | `tests/systemtests/chainupgrade/v0_1_10_to_v0_2_0.go`: el plan on-chain debe coincidir con **`UpgradeName`** en `infinited/upgrades.go` (hoy **`infinite-v0.1.10-to-v0.2.0`**; ver [migrations/infinite_v0.1.10_to_v0.2.0.md](../../migrations/infinite_v0.1.10_to_v0.2.0.md)). |
