...
| [**PLAYBOOK.md**](PLAYBOOK.md) | Procedimiento de integración con upstream (antes, durante, después), incluye **Apéndice A** (marcadores de conflicto, `evmd`/`infinited`, Make con espacios, CI). |
