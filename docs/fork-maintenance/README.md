...
| [**logs/**](logs/) | Bitácoras de merge upstream (**crear al inicio**, **completar al cierre** — [logs/README.md](logs/README.md)) y, si aplica, **cierre de features del fork** (p. ej. [Hyperlane](logs/2026-04-03-hyperlane-integration.md)). |
