...
| [**migrations/**](migrations/) | Guías por salto de versión del stack cosmos/evm (`v0.*_to_v0.*.md`); plan de software-upgrade del fork: [infinite_v0.1.10_to_v0.2.0.md](migrations/infinite_v0.1.10_to_v0.2.0.md). |
