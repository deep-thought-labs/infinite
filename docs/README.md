...
| [**feature/hyperlane/**](feature/hyperlane/README.md) | Hyperlane (`x/core`, `x/warp`): [README](feature/hyperlane/README.md), registro técnico [INTEGRATION.md](feature/hyperlane/INTEGRATION.md); referenciado desde [fork-maintenance/UPSTREAM_DIVERGENCE_RECORD.md](fork-maintenance/UPSTREAM_DIVERGENCE_RECORD.md#extensiones-de-producto-fork). |
